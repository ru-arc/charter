...
7. Учет рекомендаций ведется в online excel sheet, в базе данных или в специально разработанной информационной системе, правила (инварианты) которых должны реализовывать требования данного раздела Устава:
